...
import utp.edu.pe.ayapalleckmuchik.interfaces.HabitacionDAOinterface;
...
public class HabitacionDAO implements AutoCloseable, HabitacionDAOinterface {
    ...
    public List<Habitacion> getHabitacionesByEstado(String estado) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Habitacion habitacion = new Habitacion(rs.getInt("id_habitacion"),
                        rs.getString("numero_habitacion"), rs.getString("estado"),
                        rs.getString("estado_limpieza"),
                        tipoHabitacionDAO.getTipoHabitacionById(rs.getInt("id_tipo_habitacion")));
                habitaciones.add(habitacion);
            }
            pstmt.close();
