      ...
      <div class="table-responsive">
        <table class="table" style="text-align: center;">
          ...
          <tr>
            ...
            <td>
              <div style="display: flex; justify-content: space-between; align-items: center; align-content: center; padding: 10px 20px; gap: 20px;">
                <a href="<%= request.getContextPath() %>/acceptSolicitud?id=<%= solicitud.getId_solicitud() %>">Aceptar</a>
                <a href="<%= request.getContextPath() %>/cancelSolicitud?id=<%= solicitud.getId_solicitud() %>">Cancelar</a>
              </div>
            </td>
